...
def main():
    ...
    parser.add_argument(
        '--file','-f',
        type=str,
        default='/Users/liv/trackML/train_1.zip',
    ...
    # # 2. Plot the detector & truth before running track building
    # if PLOT:
    ...
    #     trk_plot.plot_truth_paths_rz(truth_hits, max_tracks=None)
    #     trk_plot.plot_truth_paths_3d(truth_hits, max_tracks=None)
    ...
    for i, track in enumerate(best_tracks):
        ...
        # Plot best tracks
        if PLOT and i < 3:  # Plot first 3 tracks
    ...
    # 9. Create final submission and score
    if submission_list:
